...
//      alert('2')
//      setTimeout(function(){console.log(swiper.activeIndex);animation_page()},100)
...
setTimeout(function(){
  ...
  var Navigation = {
    ...
    onPrevClick: function onPrevClick(e) {
      var swiper = this;
      e.preventDefault();
		//code Edited by Arun start//
		if (swiper.isBeginning) {
			goBeginPage();
		}else if(swiper.isBeginning && !swiper.params.loop){
			return;
		}
		//code Edited by Arun end//
		swiper.slidePrev();
    },
...
//            alert();
  ...
  var a11y = {
    ...
    addElLabel: function addElLabel($el, label) {
		...
		var lab_id=label.split(' ')[1]
		console.log(lab_id);
	  $el.attr('id','bullet_'+lab_id);
      return $el;
    },
    ...
    updatePagination: function updatePagination() {
      ...
      if (swiper.pagination && swiper.params.pagination.clickable && swiper.pagination.bullets && swiper.pagination.bullets.length) {
        swiper.pagination.bullets.each(function (bulletIndex, bulletEl) {
          ...
          swiper.a11y.addElLabel($bulletEl, params.paginationBulletMessage_1.replace(/{{index}}/, $bulletEl.index() + 1));
        });
      }
    },
    init: function init() {
  ...
  var A11y = {
    ...
    params: {
      a11y: {
        ...
        prevSlideMessage: 'Previous arrow',
        nextSlideMessage: 'Next arrow',
        firstSlideMessage: 'This is the first slide',
        lastSlideMessage: 'This is the last slide',
        paginationBulletMessage: '123456789',
        paginationBulletMessage_1: 'Slide {{index}} of 4',
		//id:'bullet_{{index}}'  
      },
    },
    create: function create() {
  ...
  var Flip = {
    ...
    setTransition: function setTransition(duration) {
      ...
      if (swiper.params.virtualTranslate && duration !== 0) {
		...
		//console.log("dinesh:::::::",activeIndex)
    },
  };
